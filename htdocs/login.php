...
<html lang="en">
  ...
  <form method="post">
		...
		<button class="SignupButton" type="submit" name="login" value="Login" >SIGN IN</button>
		<span class="Signup">Don't have an account? <a href="register.php">Sign up</a></span>
  </form>
	  </div>
